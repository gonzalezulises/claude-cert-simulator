            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">
                  ...
                  {locale === "es" ? "Fundamentos" : "Fundamentals"}
                </p>
              ...
              <div>
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">
                  ...
                  {locale === "es" ? "Herramientas — MCP" : "Tools — MCP"}
                </p>
                <div className="space-y-0.5">
                  ...
                  <a href="https://code.claude.com/docs/en/mcp" target="_blank" rel="noopener noreferrer" className="block text-xs text-primary hover:underline">MCP in Claude Code</a>
                  <a href="https://github.com/modelcontextprotocol" target="_blank" rel="noopener noreferrer" className="block text-xs text-primary hover:underline">MCP Community Servers</a>
                </div>
              </div>
              <Separator />
              <div>
                ...
                {Object.entries(domainNames).map(([key, name]) => {
                  ...
                  return (
                    <Button
                      key={d}
                      variant="ghost"
                      className="justify-between h-auto py-1.5 px-3 text-left"
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-3 gap-2 text-center text-sm">
                ...
                <div className="bg-muted rounded-lg p-2">
                  ...
                  <p className="text-[10px] text-muted-foreground">{t("exam.minPass", locale)}</p>
                </div>
              </div>
              ...
              <Separator />
              <ProgressDashboard progress={progress} locale={locale} embedded />
